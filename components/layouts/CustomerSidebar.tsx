...
export default function CustomerSidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={`
        fixed left-0 top-0 h-screen w-64 bg-linear-to-b from-slate-900 to-slate-800 border-r border-white/10
      ...
      `}>
        ...
        <div className="p-6 border-b border-white/10">
          <Link href="/customer/dashboard" className="flex items-center gap-2">
            <div className="w-10 h-10 rounded-lg bg-linear-to-br from-amber-400 to-orange-500 text-white flex items-center justify-center font-bold text-lg">
              R
            </div>
            <div>
          ...
          {navItems.map((item) => (
            <Link
              ...
              className={`
                ...
                ${isActive(item.href)
                  ? 'bg-linear-to-r from-amber-500/20 to-orange-500/20 text-amber-400 border border-amber-500/30'
