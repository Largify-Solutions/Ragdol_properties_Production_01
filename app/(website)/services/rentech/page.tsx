    ...
    <div className="bg-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {rentechServices.map((service, idx) => {
              ...
              return (
                <div 
                  key={idx}
                  className="group bg-white border border-indigo-400/20 rounded-2xl p-6 hover:border-indigo-400/50 transition-all duration-300 hover:shadow-xl hover:shadow-indigo-400/10"
                >
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {stats.map((stat, idx) => (
            <div key={idx} className="bg-white border border-indigo-400/20 rounded-2xl p-8 text-center hover:border-indigo-400/50 transition-all">
