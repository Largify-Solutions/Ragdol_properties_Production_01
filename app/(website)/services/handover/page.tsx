    ...
    <div className="bg-white">
      ...
      <section id="details" className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Handover Services</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">Comprehensive handover management covering all phases of property transfer</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {handoverServices.map((service, idx) => {
              ...
              return (
                <div 
                  key={idx}
                  className="group bg-white border border-emerald-400/20 rounded-2xl p-6 hover:border-emerald-400/50 transition-all duration-300 hover:shadow-xl hover:shadow-emerald-400/10"
                >
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {stats.map((stat, idx) => (
            <div key={idx} className="bg-white border border-emerald-400/20 rounded-2xl p-8 text-center hover:border-emerald-400/50 transition-all">
        ...
        <h2 className="text-4xl font-bold text-gray-900 mb-12 text-center">Why Choose fäm Handover Services?</h2>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold text-gray-900 mb-12 text-center">Ideal For</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            {[
              ...
              <div key={idx} className="bg-white border border-emerald-400/20 rounded-2xl p-6 text-center hover:border-emerald-400/50 transition-all">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Handover Process</h2>
            <p className="text-xl text-gray-600">Our systematic approach to seamless property transfer</p>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold text-gray-900 mb-12 text-center">Handover Experience</h2>
