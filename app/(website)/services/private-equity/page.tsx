  ...
  return (
    <div className="bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            <h1 className="text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              Real Estate <span className="bg-linear-to-r from-[#8A6508] to-[#5C4204] bg-clip-text text-transparent">Private Equity</span>
            </h1>
            ...
            <div className="flex gap-4 flex-wrap">
              ...
              <Link href="#details" className="px-8 py-4 border-2 border-white/60 text-white font-bold rounded-lg hover:bg-white/10 transition-all duration-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
              Build Wealth Through <span className="bg-linear-to-r from-[#8A6508] to-[#5C4204] bg-clip-text text-transparent">Strategic Real Estate Investing</span>
            </h2>
      ...
      <section id="details" className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Private Equity Investment Services</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">Complete solutions from sourcing to exit for optimal portfolio performance</p>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <h2 className="text-4xl font-bold text-gray-900 mb-12 text-center">Why Choose fäm Private Equity?</h2>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Our systematic approach to maximizing returns</p>
          </div>
      ...
      {/* Portfolio Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <h2 className="text-4xl font-bold text-gray-900 mb-12 text-center">Investment Portfolio Showcase</h2>
