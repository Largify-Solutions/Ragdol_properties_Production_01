...
// // Agent Data Interface - SAME AS LUXE
// interface AgentData {
//   id?: string;
//   title?: string;
...
// // Floor Plan Form Component - SAME AS LUXE
...
//       // ... (Same PDF generation code as Luxe)
...
//                     rows={3}
//                     className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
//                     placeholder="Any specific property requirements..."
//                   />
//                 </div>
//               </div>
...
//                     type="button"
//                     onClick={onClose}
//                     className="px-8 py-1 border-2 border-gray-300 text-gray-700 font-bold rounded-xl hover:bg-gray-50 transition-colors"
//                   >
//                     Cancel
//                   </button>
//                   <button
...
//                       <>
//                         <span>📥</span>
//                         Download Details & Submit Inquiry
//                       </>
//                     )}
//                   </button>
//                 </div>
...
// // Agent Popup Modal Component - SAME AS LUXE
...
//                       {(agentData?.specializations || ['Sale Properties']).map((spec: string, idx: number) => (
//                         <span 
//                           key={idx} 
...
//                           "Discover this exceptional property available for sale. Featuring modern design and premium amenities."}
//                       </p>
//                     </div>
//                   </div>
...
//                       Fill out the form below for purchase inquiries.
//                     </p>
  ...
  return (
    <div className="fixed inset-0 z-[2000] bg-black flex flex-col">
      ...
      >
        ...
        >
          ...
          <img
            ...
            className={`transition-all duration-300 ${
              isZoomed 
                ? 'object-contain w-auto h-auto max-w-[2000px] max-h-[2000px]' 
            ...
            onError={(e) => {
              ...
              setImageLoaded(true); // Error hone par bhi loading hide karo
            }}
            style={{
        ...
        {images.length > 1 && !isZoomed && imageLoaded && (
          <>
            <button
              onClick={(e) => {
                e.stopPropagation();
              ...
              className="absolute left-4 top-1/2 -translate-y-1/2 h-12 w-12 rounded-full bg-black/50 flex items-center justify-center text-white hover:bg-black/70 transition-colors z-20"
            >
            ...
            <button
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 h-12 w-12 rounded-full bg-black/50 flex items-center justify-center text-white hover:bg-black/70 transition-colors z-20"
            >
        ...
        {isZoomed && imageLoaded && (
          <div className="absolute bottom-4 right-4 bg-black/50 text-white px-3 py-2 rounded-lg backdrop-blur-sm z-20">
      ...
      {images.length > 1 && !isZoomed && imageLoaded && (
        <div className="p-4 bg-black/80 backdrop-blur-md border-t border-gray-800">
