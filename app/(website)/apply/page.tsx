      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
        <div className="max-w-md w-full bg-white rounded-[2.5rem] p-12 text-center shadow-xl shadow-slate-200/50 border border-slate-100">
          ...
          <p className="text-slate-500 mb-10 leading-relaxed">
            Thank you for your interest in joining Ragdoll Properties. Our talent acquisition team will review your profile and get back to you within 48 hours.
          </p>
          <Link 
            href="/"
            ...
            <div className="lg:col-span-2">
              <form onSubmit={handleSubmit} className="space-y-8 bg-white p-8 md:p-12 rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100">
                ...
                <div className="space-y-6 pt-8 border-t border-slate-100">
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-bold text-slate-400 uppercase tracking-widest">Why Ragdoll Properties? (Cover Letter)</label>
                    <textarea 
                      name="message"
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-8">
                    {[
                      ...
                      { step: '03', title: 'Onboarding', desc: 'Welcome to the elite Ragdoll Properties collective.' }
                    ].map((item, i) => (
