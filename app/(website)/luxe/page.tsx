...
//     if (category === 'luxe') return 'Exclusive collection of luxury properties for discerning buyers.';
...
//                 <button
//                   onClick={() => handleFilterClick('feature', 'villas')}
//                   className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${feature === 'villas' ? 'bg-amber-500 text-white' : 'bg-amber-50 text-amber-600 hover:bg-amber-100'}`}
//                 >
//                   🏰 Villas
//                 </button>
//                 <button
//                   onClick={() => handleFilterClick('feature', 'townhouse')}
//                   className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${feature === 'townhouse' ? 'bg-teal-500 text-white' : 'bg-teal-50 text-teal-600 hover:bg-teal-100'}`}
//                 >
//                   🏘️ Townhouses
//                 </button>
//                 <button
//                   onClick={() => handleFilterClick('feature', 'apartments')}
//                   className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${feature === 'apartments' ? 'bg-purple-500 text-white' : 'bg-purple-50 text-purple-600 hover:bg-purple-100'}`}
//                 >
//                   🏢 Apartments
//                 </button>
//               </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-white">
      ...
      <div className="container-custom py-8 sm:py-16 bg-white">
        <div className="flex flex-col">
          {/* View Controls and Filters */}
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 sm:mb-10 gap-4 sm:gap-6 bg-white p-4 sm:p-4 rounded-2xl sm:rounded-3xl border border-white shadow-sm">
            <div className="flex items-center gap-4 pl-4">
              <span className="text-black-400 font-bold text-sm uppercase tracking-widest">
                {total} Properties Found
              </span>
            </div>
          ...
          {filteredProperties.length > 0 ? (
                    ...
                    <div key={`${property.collection}-${property.id}`} className="animate-slide-up" style={{ animationDelay: `${i * 50}ms` }}>
                      <div className="relative group">
                        ...
                        <button
                          ...
                          className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-all duration-300 bg-white/90 backdrop-blur-md rounded-xl px-4 py-2 shadow-lg hover:shadow-xl hover:bg-white border border-amber-200 flex items-center gap-2 text-amber-700 hover:text-amber-600 font-bold text-sm z-10"
                        >
            ...
            <div className="text-center py-32 bg-white rounded-[3rem] border border-amber-100 shadow-sm">
              <div className="h-24 w-24 bg-white-50 rounded-full flex items-center justify-center mx-auto mb-6">
                <HomeIcon className="h-12 w-12 text-amber-300" />
              </div>
              <h3 className="text-2xl font-black text-amber-900 mb-2">No properties found</h3>
              <p className="text-amber-500 font-medium max-w-xs mx-auto">
