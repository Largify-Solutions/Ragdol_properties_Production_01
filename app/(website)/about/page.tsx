      ...
      <section className="py-24 bg-linear-to-br from-slate-900 to-secondary">
        <div className="container-custom">
          ...
          {loadingPartners ? (
            ...
            <>
              {partnersError && (
                <div className="mb-8 p-4 bg-[#FFC636]/10 border border-[#FFC636]/20 rounded-lg max-w-2xl mx-auto">
                  <p className="text-[#FFC636]/60 text-sm text-center">
                    {partnersError}
                  </p>
                </div>
              )}
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-1">
                          {[...Array(5)].map((_, i) => (
                            <svg key={i} className={`h-4 w-4 ${i < Math.floor(agent.rating) ? 'text-[#FFC636]' : 'text-slate-300'}`} fill="currentColor" viewBox="0 0 20 20">
