  ...
  const sections = [
    {
      ...
      content: 'By accessing Ragdoll Properties, you agree to be bound by these elite service standards and legal frameworks.'
    },
    {
      icon: ScaleIcon,
              ...
              <div className="prose prose-slate prose-lg max-w-none space-y-12">
                <section>
                  ...
                  <p className="text-slate-600 leading-relaxed">
                    Welcome to Ragdoll Properties ("we," "our," or "us"). These Terms of Service ("Terms") govern your use of our website,
                ...
                <section>
                  ...
                  <p className="text-slate-600 leading-relaxed mb-6">
                    Ragdoll Properties is UAE's premier real estate platform that connects buyers, sellers, renters, and real estate
